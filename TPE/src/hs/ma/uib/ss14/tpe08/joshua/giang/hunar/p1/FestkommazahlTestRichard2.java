 ...
 */
public class FestkommazahlTestRichard2 {
	...
	protected void setUp() {
		a = new Festkommazahl(100, 0, 18);
		b = new Festkommazahl(0, 5, -5);
		c = new Festkommazahl(0, 80, 6);
		d = new Festkommazahl(0, 0, 4);

	}

	/**
	 * Test des Konstruktors <code>Festkommazahl(long, long, int)</code> mit dP = 0
	 */
	@Test
	...
	public void testAddiere1() {
		setUp();
		assertEquals(new Festkommazahl(100, 5, 6), a.addiere(b));
		assertEquals(new Festkommazahl(100, 5, 6), b.addiere(a));
	}
	...
	public void testAddiere2() {
		setUp();
		assertEquals(new Festkommazahl(0, 85, 6), b.addiere(c));
		assertEquals(new Festkommazahl(0, 85, 6), c.addiere(b));
	}
	...
	public void testAddiere3() {
		setUp();
		assertEquals(new Festkommazahl(0, 0, 6), d.addiere(d));
	}
	...
	public void testSubtrahiere1() {
		setUp();
		assertEquals(new Festkommazahl(99, 95, 6), a.subtrahiere(b));
	}
	...
	public void testSubtrahiere2() {
		setUp();
		assertEquals(new Festkommazahl(0, 75, 6), c.subtrahiere(b));
	}
	...
	public void testMultipliziere1() {
		setUp();
		assertEquals(new Festkommazahl(5, 0, 6), a.multipliziere(b));
		assertEquals(new Festkommazahl(5, 0, 6), b.multipliziere(a));
	}
	...
	public void testMultipliziere2() {
		setUp();
		assertEquals(new Festkommazahl(0, 4, 6), c.multipliziere(b));
		assertEquals(new Festkommazahl(0, 4, 6), b.multipliziere(c));
	}
	...
	public void testMultipliziere3() {
		setUp();
		assertEquals(new Festkommazahl(0, 0, 6), d.multipliziere(d));
	}
	...
	public void testMultipliziereDouble1() {
		setUp();
		assertEquals(new Festkommazahl(2, 0, 6), c.multipliziere(2.5));
	}
	...
	public void testMultipliziereDouble3() {
		setUp();
		assertEquals(new Festkommazahl(0, 0, 6), a.multipliziere(0.0));
	}
	...
	public void testDividiere1() {
		setUp();
		assertEquals(new Festkommazahl(20, 0, 6), a.dividieren(5.0));
	}
	...
	public void testDividiere2() {
		setUp();
		assertEquals(new Festkommazahl(4, 0, 6), c.dividieren(0.2));
	}
	...
	public void testDividiere3() {
		setUp();
		assertEquals(new Festkommazahl(0, 0, 6), d.dividieren(5.0));
	}
	...
	public void testProzent1() {
		setUp();
		assertEquals(new Festkommazahl(120, 54, 6), a.prozent(120.54));
	}
	...
	public void testProzent2() {
		setUp();
		assertEquals(new Festkommazahl(4, 50, 6), a.prozent(4.5));
	}
	...
	public void testProzent3() {
		setUp();
		assertEquals(new Festkommazahl(0, 0, 4), d.prozent(140.5));
	}
	...
	public void testParse3() {
		setUp();
		assertEquals(c, c.parse("0,800000"));
	}
